    ...
    <div class="background-img login-height">
        ...
        <div class="login-form">
            ...
            <form action="home" method="POST" >
                ...
                <input type="hidden" name="token_login" value="<?php echo $this->csrf_login(); ?>">

                <button type="submit" name="login_user" class="btn btn-primary mb-4 col-md-12" >Login</button>
            </form>
            
            <a class="btn btn-warning" href="home">Enter as guest</a></label><br><br>
            <a class="text-primary text-left" href="register">Signup Now</a> <br>
        </div>
    </div>
</div>
